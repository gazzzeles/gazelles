...
function App() {
  ...
  const scrambleText = (textElement) => {
  ...
  return (
    <>
      ...
      <div className="ST" title="404">MY STACK</div>
      ...
      <div className="ST" title="404">MY LINKS</div>
      ...
      <div className="contact-info">
        ...
        <ul>
          ...
          <li >Telegram: <a href="https://t.me/ggazzelles" className="tg" target="_blank" rel="noopener noreferrer">@ggazzelles</a></li>
        </ul>
      </div>
    </footer>
      </div>
